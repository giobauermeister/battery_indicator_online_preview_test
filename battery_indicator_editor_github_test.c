/**
 * @file battery_indicator_editor_github_test.c
 */
...
void battery_indicator_editor_github_test_init(const char * asset_path)
{
    battery_indicator_editor_github_test_init_gen(asset_path);
